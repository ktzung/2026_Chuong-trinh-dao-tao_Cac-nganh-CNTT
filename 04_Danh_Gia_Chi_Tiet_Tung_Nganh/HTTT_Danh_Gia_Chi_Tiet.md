...
## IX. Bảng phân bổ tín chỉ theo học kỳ — Khung CTĐT mới đề xuất (HTTT)
...
| **II.1** | **Nền tảng CNTT & dữ liệu** | **27** | | | | | | | | |
| 15 | Lập trình Python cho Phân tích dữ liệu | 3 | 3 | | | | | | | |
| 16 | CTDL & Giải thuật | 3 | | 3 | | | | | | |
| 17 | Cơ sở dữ liệu & Thiết kế dữ liệu | 3 | | 3 | | | | | | |
| 18 | Mạng máy tính & Hạ tầng | 3 | | 3 | | | | | | |
| 19 | Kiến trúc máy tính & HĐH | 3 | | 3 | | | | | | |
| 20 | Lập trình hướng đối tượng (nhẹ) | 3 | | | 3 | | | | | |
| 21 | Phân tích & Thiết kế HTTT | 3 | | | 3 | | | | | |
| 22 | Toán rời rạc | 3 | | 3 | | | | | | |
| 23 | Xác suất thống kê ứng dụng | 3 | | | 3 | | | | | |
| **II.2** | **Lõi hệ thống thông tin & AI** | **30** | | | | | | | | |
| 24 | Phân tích dữ liệu & Python Data Stack | 3 | | | 3 | | | | | |
| 25 | **CLD-1: Cloud Computing & Cloud Data Services (BB)** | 3 | | | 3 | | | | | |
| 26 | WEB-A1: Phát triển web & data dashboard | 3 | | | | 3 | | | | |
| 27 | **DATA-ENG: Kỹ thuật dữ liệu & ETL Pipeline (BB mới)** | 3 | | | | 3 | | | | |
| 28 | **Kho dữ liệu & Data Warehouse Hiện đại (BB)** | 3 | | | | 3 | | | | |
| 29 | **Học máy ứng dụng cho HTTT** | 3 | | | | | 3 | | | |
| 30 | **AI Engineering cho Doanh nghiệp (BB mới)** | 3 | | | | | 3 | | | |
| 31 | Hệ quản trị CSDL & Cloud Database | 3 | | | | | 3 | | | |
| 32 | Khai phá dữ liệu & AI Analytics | 3 | | | | | | 3 | | |
| 33 | Thiết kế HTTT hiệu năng nâng cao | 3 | | | | | | 3 | | |
| **II.3** | **Hệ thống doanh nghiệp & chuyên ngành (1 track)** | **12** | | | | | | | | |
| 34–37 | Track A / B / C (xem mục IV) | 12 | | | | | | | 12 | |
| **II.4** | **Thực tập & Đồ án** | **14** | | | | | | | | |
| 38 | Thực tập tốt nghiệp | 4 | | | | | | | | 4 |
| 39 | Đồ án tốt nghiệp | 10 | | | | | | | | 10 |
| | **Tổng cộng** | **140** | **12** | **21** | **21** | **16** | **18** | **9** | **15** | **14** |

> **Lưu ý:** HK6 nhẹ hơn để sinh viên tập trung vào thực tập doanh nghiệp. Có thể chuyển một số môn tự chọn từ HK7 sang HK6 nếu cần cân bằng.
